...
class MinOpriceFilter(Filter):
    ...
    def Judge(self, item: Item) -> bool:
        return item.origin_price >= self.min_oprice
...
class MaxOpriceFilter(Filter):
    ...
    def Judge(self, item: Item) -> bool:
        return item.origin_price <= self.max_oprice
...
class MinDiscountFilter(Filter):
    ...
    def Judge(self, item: Item) -> bool:
        return item.discount >= self.min_discount
...
class MaxDiscountFilter(Filter):
    ...
    def Judge(self, item: Item) -> bool:
        return item.discount <= self.max_discount
